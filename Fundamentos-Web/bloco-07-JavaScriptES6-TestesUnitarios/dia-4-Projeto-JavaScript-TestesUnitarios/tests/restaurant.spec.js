...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {    
    ...
    expect(Object.keys(objetoRetornado)).toContain('consumption');
    ...
    objetoRetornado = createMenu({ food: {coxinha: 5.00}, drink: {} });
    expect(Object.keys(objetoRetornado)).toContain('order');
    ...
    objetoRetornado = createMenu({ food: {coxinha: 5.00, sopa: 12.50, sashimi: 19.90}, drink: {agua: 2.50} }); 
    objetoRetornado.order("coxinha");   
    ...
    objetoRetornado = createMenu({ food: {coxinha: 5.00}, drink: {agua: 2.50} }); 
    objetoRetornado.order("coxinha");
    objetoRetornado.order("agua");
    objetoRetornado.order("coxinha");
    objetoRetornado.order("coxinha");
    expect(objetoRetornado.consumption).toEqual(['coxinha', 'agua', 'coxinha', 'coxinha']);
    // objetoRetornado.order('coxinha');
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
    // objetoRetornado.consumption // Retorno: ['coxinha', 'agua', 'sopa', 'sashimi', 'coxinha', 'agua', 'coxinha']
    ...
    objetoRetornado.order('agua');
    objetoRetornado.order('coxinha');
    expect(objetoRetornado.pay()).toBe(12.5);
    // objetoRetornado.order('coxinha');
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
