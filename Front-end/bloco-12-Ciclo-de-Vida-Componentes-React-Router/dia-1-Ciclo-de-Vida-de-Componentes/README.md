# DIA 1 Ciclo de Vida de Componentes e React Router

## Ciclo de vida de componentes

01 - Crie uma aplicação que consuma a API de fotos aleatórias de cachorros. Use a dog.ceo. Para refrescar a memória acerca de como fazer requisições, revisite o conteúdo sobre Promises ou consulte a documentação]!
...
02 - Com o código do exercício anterior, você irá implementar mais algumas funcionalidades:
...
Bônus - Com o código do ultimo exercício, implemente:
